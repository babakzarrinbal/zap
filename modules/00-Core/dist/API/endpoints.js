...
function create(dbpath, endpointinfo) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var db, newId, validationData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, initDatabase(dbpath)];
                case 1:
                    db = _a.sent();
                    return [4 /*yield*/, queryEndpoint.insertEndpoint(db, endpointinfo.sessionId, endpointinfo.endpointId, endpointinfo.endpointType, endpointinfo.networkId, endpointinfo.profileId, endpointinfo.endpointVersion, endpointinfo.deviceIdentifier)];
                case 2:
                    newId = _a.sent();
 ...
 */
function getOne(dbpath, endpointId) {
    return __awaiter(this, void 0, void 0, function () {
        var db;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    db = _a.sent();
                    return [4 /*yield*/, queryEndpoint.selectEndpoint(db, endpointId)];
