...
exports.map = {
    ...
    commandArgument: function (x) {
        ...
        return {
            ...
            caption: "Command argument of type ".concat(x.TYPE),
        };
    },
    domain: function (x) {
        if (x == null)
        ...
        return {
            id: x.DOMAIN_ID,
            label: x.NAME,
            caption: "Domain, named ".concat(x.NAME),
        };
    },
    enum: function (x) {
        if (x == null)
        ...
        return {
            ...
            name: x.NAME,
            type: x.TYPE,
            caption: "Enum of type ".concat(x.TYPE),
        };
    },
    enumItem: function (x) {
        if (x == null)
        ...
        return {
            ...
            value: x.VALUE,
            enumRef: x.ENUM_REF,
            caption: "EnumItem, named ".concat(x.NAME),
        };
    },
    struct: function (x) {
        if (x == null)
        ...
        return {
            ...
            caption: "Struct, named ".concat(x.NAME),
        };
    },
    structItem: function (x) {
        if (x == null)
            return undefined;
        return {
            name: x.NAME,
    ...
    bitmapField: function (x) {
        ...
        return {
            ...
            caption: "BitmapField, named ".concat(x.NAME),
        };
    },
    deviceType: function (x) {
        if (x == null)
            return undefined;
        return {
            id: x.DEVICE_TYPE_ID,
    ...
    deviceTypeAttribute: function (x) {
        if (x == null)
            return undefined;
        return {
    ...
    endpointTypeCluster: function (x) {
        if (x == null)
            return undefined;
        return {
    ...
    endpointTypeAttribute: function (x) {
        if (x == null)
            return undefined;
        return {
            endpointTypeRef: x.ENDPOINT_TYPE_REF,
    ...
    endpointTypeCommand: function (x) {
        if (x == null)
            return undefined;
        return {
            endpointTypeRef: x.ENDPOINT_TYPE_REF,
    ...
    packageExtensionDefault: function (x) {
        if (x == null)
            return undefined;
        return {
...
//# sourceMappingURL=db-mapping.js.map