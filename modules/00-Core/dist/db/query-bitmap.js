...
function createCache(db, packageId) {
    return __awaiter(this, void 0, void 0, function () {
        var packageSpecificCache, d, d_1, d_1_1, b;
        var e_1, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, selectAllBitmaps(db, packageId)];
                case 1:
                    d = _b.sent();
...
function selectAllBitmaps(db, packageId) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, dbApi.dbAll(db, "\nSELECT\n  BITMAP_ID,\n  NAME,\n  TYPE\nFROM BITMAP\nWHERE PACKAGE_REF = ? ORDER BY NAME", [packageId])];
                case 1:
                    rows = _a.sent();
                    return [2 /*return*/, rows.map(dbMapping.map.bitmap)];
            }
        });
    });
}
function selectAllBitmapsFromCache(db, packageId) {
    return __awaiter(this, void 0, void 0, function () {
        var cache;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, dbApi
                    .dbGet(db, "\nSELECT\n  BITMAP_ID,\n  NAME,\n  TYPE\nFROM BITMAP\nWHERE NAME = ? AND PACKAGE_REF = ?", [name, packageId])
                    .then(dbMapping.map.bitmap)];
        });
    });
}
function selectBitmapByNameFromCache(db, name, packageId) {
    return __awaiter(this, void 0, void 0, function () {
        var cache;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
function selectBitmapByIdFromCache(db, id) {
    return __awaiter(this, void 0, void 0, function () {
        var cache;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
//# sourceMappingURL=query-bitmap.js.map