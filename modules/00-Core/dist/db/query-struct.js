...
function createCache(db, packageId) {
    return __awaiter(this, void 0, void 0, function () {
        var packageSpecificCache, d, d_1, d_1_1, s;
        var e_1, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, selectAllStructs(db, packageId)];
                case 1:
                    d = _b.sent();
...
function selectAllStructs(db, packageId) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, dbApi.dbAll(db, 'SELECT STRUCT_ID, NAME FROM STRUCT WHERE PACKAGE_REF = ? ORDER BY NAME', [packageId])];
                case 1:
                    rows = _a.sent();
                    return [2 /*return*/, rows.map(dbMapping.map.struct)];
            }
        });
    });
}
function selectAllStructsFromCache(db, packageId) {
    return __awaiter(this, void 0, void 0, function () {
        var cache;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
function selectStructByIdFromCache(db, id) {
    return __awaiter(this, void 0, void 0, function () {
        var cache;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
function selectStructByName(db, name, packageId) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, dbApi
                    .dbGet(db, 'SELECT STRUCT_ID, NAME FROM STRUCT WHERE NAME = ? AND PACKAGE_REF = ? ORDER BY NAME', [name, packageId])
                    .then(dbMapping.map.struct)];
        });
    });
}
function selectStructByNameFromCache(db, name, packageId) {
    return __awaiter(this, void 0, void 0, function () {
        var cache;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
exports.selectStructByName = dbCache.cacheEnabled
    ...
    : selectStructByName;
//# sourceMappingURL=query-struct.js.map