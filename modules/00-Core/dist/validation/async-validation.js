...
exports.initAsyncValidation = void 0;
var queryPackage = require('../db/query-package.js');
var sessionTimers = require('../main-process/session-timers.js');
var wsServer = require('../server/ws-server.js');
var dbEnum = require('../src-shared/db-enum.js');
var ASYNC_ENFORCE_COMMON_CLUSTER_SPEC_INTERVAL_MS = 3000;
var TimerTypeFunctionMap = {
...
*
*/
function initAsyncValidation(db, session) {
    return __awaiter(this, void 0, void 0, function () {
        var validationTimers, timers, validationTimersFlag;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, queryPackage.getSessionPackages(db, session.sessionId)
                        .then(function (packages) {
                        var p = packages.map(function (pkg) {
                            return queryPackage.selectAllOptionsValues(db, pkg.packageRef, dbEnum.packageOptionCategory.validationTimersFlags);
                        });
                        return Promise.all(p).then(function (data) { return data.flat(1); });
                    })];
                case 1:
                    validationTimers = _a.sent();
                    timers = [];
                    validationTimersFlag = {};
                    validationTimers.forEach(function (data) {
...
function zigbeeEnforceCommonClusterSpecCallback(session) {
    var socket = wsServer.clientSocket(session.sessionKey);
    if (socket) {
...
exports.initAsyncValidation = initAsyncValidation;
//# sourceMappingURL=async-validation.js.map