...
var scriptApi = require('./script-api.js');
 ...
 * @param {*} script
 */
function executeScriptFunction(functionName, context, script) {
    return __awaiter(this, void 0, void 0, function () {
        var resolvedPath, loadedScript;
        return __generator(this, function (_a) {
            resolvedPath = path.resolve(script);
            loadedScript = nativeRequire(resolvedPath);
            if (loadedScript[functionName]) {
                return [2 /*return*/, loadedScript[functionName](scriptApi, context)];
            }
            return [2 /*return*/];
        });
    });
