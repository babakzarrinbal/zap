 ...
 */
var templateUtil = require('../generator/template-util.js');
...
function all_user_cluster_commands_helper(options) {
    ...
    var promise = templateUtil
        ...
        return queryEndpointType.selectClustersAndEndpointDetailsFromEndpointTypes(_this.global.db, endpointTypes);
    })
        .then(function (endpointsAndClusters) {
        return queryCommand.selectCommandDetailsFromAllEndpointTypesAndClusters(_this.global.db, endpointsAndClusters, true);
    });
    return promise;
}
exports.all_user_cluster_commands_helper = all_user_cluster_commands_helper;
//# sourceMappingURL=iterator-util.js.map